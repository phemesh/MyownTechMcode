...
public class TestConfig{
	...
	public static String from = "hemeswarpolina@gmail.com";
	public static String password = "Sivaram@2059b";
	public static String[] to ={"hemeswarpolina@gmail.com","p.hemesh79@gmail.com"};
	...
	public static void main(String[] args) throws AddressException, MessagingException {
		...
		//mm.sendMail(server, from, to, subject, messageBody);
	}
